...
EMAIL_HOST_USER = 'senesie@gmail.com'
EMAIL_HOST_PASSWORD = '030343801'  # Consider using environment variables for security
EMAIL_PORT = 587
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Ensures Django finds static files
]
