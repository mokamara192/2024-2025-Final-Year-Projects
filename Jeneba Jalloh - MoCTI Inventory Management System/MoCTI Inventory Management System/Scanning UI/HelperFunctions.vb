...
Friend Class HelperFunctions
    ...
    Public Structure WiaSupportedFormatsInfo
        ...
        Public Sub New(ByVal format_Renamed As WiaFileFormats, ByVal filter_Renamed As String, ByVal extension_Renamed As String)
            _format = format_Renamed
            _formatFilter = filter_Renamed
            _formatExtension = extension_Renamed
        End Sub
    ...
    Public Shared ReadOnly _wiaFormatsInfo() As WiaSupportedFormatsInfo = {
    ...
    Public Structure WiaPropertyValues
        ...
        Public Sub New(ByVal valueId_Renamed As UInt32, ByVal valueNameString_Renamed As String)
            _valueId = valueId_Renamed
            _valueNameString = valueNameString_Renamed
        End Sub
    ...
    Public Structure WiaPropertyValuesInfo
        ...
        Public Sub New(ByVal propertyId_Renamed As WiaPropertyId, ByVal propertyValues As WiaPropertyValues())
            _propertyId = propertyId_Renamed
    ...
    Public Shared ReadOnly _wiaPropertyValuesInfo() As WiaPropertyValuesInfo = {
    ...
    Public Shared Sub GetFormatFilterAndExtension()
        Dim format_Renamed As WiaFileFormats
        If _wiaProperties.DataTransfer.Format = WiaFileFormats.None Then ' GetProperties() method not called yet.
            format_Renamed = WiaFileFormats.Bmp
        Else
            format_Renamed = _wiaProperties.DataTransfer.Format
        End If

        For Each i As WiaSupportedFormatsInfo In _wiaFormatsInfo
            If format_Renamed = i.Format Then ' match found
                _filter = i.Filter
    ...
    Public Shared Function GetFormatNameString(ByVal guidFormat As System.Guid) As Integer
        For Each i As WiaSupportedFormatsInfo In _wiaFormatsInfo
            Dim formatGuid As Guid = Guid.Empty

            formatGuid = WiaSession.GetFormatGuid(i.Format)

            If formatGuid = guidFormat Then
    ...
    Public Shared Function GetWiaFlagPropertyValueString(ByVal propertyId As WiaPropertyId, ByVal value As Int32) As Integer
        ...
        _flagValuesStrings.Clear()

        For Each i As WiaPropertyValuesInfo In _wiaPropertyValuesInfo
            If i.PropertyId = propertyId Then
                For Each j As WiaPropertyValues In i.Values
                    If (value And j.ValueId) = j.ValueId Then
                        _flagValuesStrings.Add(j.ValueNameString)
                        foundCount += 1
                    End If
                Next j
