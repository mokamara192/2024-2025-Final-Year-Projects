...
Partial Public Class AcquireOptionsForm : Inherits DevExpress.XtraEditors.XtraForm
    ...
    Public Sub InitializeAcquireOptionsDlg()
        ...
        Else
            ...
            If Not _wiaProperties.DataTransfer.TransferMode = WiaTransferMode.None Then ' GetProperties() method already called.
                MainForm._transferMode = _wiaProperties.DataTransfer.TransferMode
            Else
    ...
    Public Sub BrowseFile()
        ...
        'Dim MyHelperform As New HelperFunctions
        HelperFunctions.GetFormatFilterAndExtension()
        'MyHelperform.GetFormatFilterAndExtension()
    ...
    Public Sub EnableFileModeOptionsControls(ByVal bEnable As Boolean)
        ...
        Else
            ...
            If _wiaProperties.DataTransfer.Format = WiaFileFormats.Tiff OrElse _wiaProperties.DataTransfer.Format = WiaFileFormats.Gif OrElse _wiaProperties.DataTransfer.Format = WiaFileFormats.Ico OrElse _wiaProperties.DataTransfer.Format = WiaFileFormats.Pdfa OrElse _wiaProperties.DataTransfer.Format = WiaFileFormats.Rtf OrElse _wiaProperties.DataTransfer.Format = WiaFileFormats.Txt OrElse _wiaProperties.DataTransfer.Format = WiaFileFormats.Html Then
