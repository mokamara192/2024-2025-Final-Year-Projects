...
def profile(request):
    ...
    if request.method == "POST":
        ...
        region = request.POST.get("region")  # Get the region from the form
        ...
        # Save the region to the vendor's profile
        if region:
            vendor.region = region

        request.user.save()
        profile.save()
        vendor.save()  # Save the vendor object after updating the region
...
def create_product(request):
    ...
    if request.method == "POST":
        ...
        shipping = request.POST.get("delivery")
