...
function Cart() {
    ...
    const createOrder = async (e) => {
        ...
        if (!bioData.full_name || !bioData.email || !bioData.country) {
            Toast("warning", "Please provide your bio data");
                                                ...
                                                {cart?.map((c, index) => (
                                                    <tr>
                                                        ...
                                                        <td className="text-center">
                                                            <h5 className="text-success mb-0">Nle{c.price}</h5>
                                                        </td>
                                                        <td>
                                ...
                                <div className="p-4 shadow rounded-3">
                                    ...
                                    <ul class="list-group mb-3">
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            Sub Total
                                            <span>Nle{cartStats.price?.toFixed(2)}</span>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            Tax
                                            <span>Nle{cartStats.tax?.toFixed(2)}</span>
                                        </li>
                                        <li class="list-group-item d-flex fw-bold justify-content-between align-items-center">
                                            Total
                                            <span className="fw-bold">Nle{cartStats.total?.toFixed(2)}</span>
                                        </li>
                                    </ul>
