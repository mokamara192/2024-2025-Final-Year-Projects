                                            ...
                                            {order?.order_items?.map((o, index) => (
                                                <tr>
                                                    ...
                                                    <td className="text-center">
                                                        <h5 className="text-success mb-0">Nle{o.price}</h5>
                                                    </td>
                                                </tr>
                                            ))}
                                        </tbody>
                                        ...
                                        <div className="p-3 shadow rounded-3 mt-3">
                                            ...
                                            <ul class="list-group mb-3">
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    Sub Total
                                                    <span>Nle{order.sub_total}</span>
                                                </li>
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    Discount
                                                    <span>Nle{order.saved}</span>
                                                </li>
                                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                                    Tax
                                                    <span>Nle{order.tax_fee}</span>
                                                </li>
                                                <li class="list-group-item d-flex fw-bold justify-content-between align-items-center">
                                                    Total
                                                    <span className="fw-bold">Nle{order.total}</span>
                                                </li>
                                            </ul>
