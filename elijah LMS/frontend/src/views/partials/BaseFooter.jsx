...
function BaseFooter() {
    return (
        <footer className="pt-lg-8 pt-5 footer bg-dark text-white" style={{ marginTop: "400px" }}>
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6 col-12 text-white">
                        ...
                        <div className="mb-4">
                            <h1>Elijah</h1>
                            <div className="mt-4">
                                <p>Elijah's is student of the Central University Sierra Leone, studing computer science.</p>
                                {/* social media */}
                    ...
                    <div className="offset-lg-1 col-lg-2 col-md-3 col-6">
                        <div className="mb-4">
                            {/* list */}
                            <h3 className="fw-bold mb-3">Developer</h3>
                    ...
                    <div className="col-lg-3 col-md-12">
                        ...
                        <div className="mb-4">
                            ...
                            <p>145 mafunday, freetownroad, mile 91</p>
                            <p className="mb-1">
                                Email:
                                <a href="#" className="text-white">
                                    {" "}
                                    etkomba058@central.edu.sl
                                </a>
                            </p>
                            <p>
                                Phone: +232 76 000000
                            ...
                            <div>
                                <nav className="nav nav-footer">
                                    ...
                                    <a className="nav-link text-white d-none d-lg-block" href="#">
                                        The Elijah's LMS is here to facilitate learning in a smoth way
                                    </a>
