...
function CourseEdit() {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await useAxios.post(`teacher/course-update/`, json);
                            ...
                            <section className="pb-8 mt-5">
                                <div className="card mb-3">
                                    ...
                                    <div className="card-header border-bottom px-4 py-3 d-flex justify-content-between align-items-center">
                                        <h4 className="mb-0 fw-bold">Course Info</h4>
                                        <Link to={`/instructor/edit-course/${param?.course_id}/curriculum/`} className="btn btn-primary btn-sm">
