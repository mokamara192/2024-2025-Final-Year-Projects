...
function Dashboard() {
    ...
    const handleDeleteCourse = async (course_id) => {
        try {
            await useAxios.delete(`/teacher/course-delete/${course_id}/`);
            fetchCourseData();
                            ...
                            <div className="row mb-4">
                                ...
                                <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                                    <div className="d-flex justify-content-center align-items-center p-4 bg-success bg-opacity-10 rounded-3">
                                        ...
                                        <div className="ms-4">
                                            <div className="d-flex">
                                                <h5 className="purecounter mb-0 fw-bold">Nle{stats.total_revenue?.toFixed(2)}</h5>
                                            </div>
                                        ...
                                        <tbody>
                                            {courses?.map((c, index) => (
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p className="mt-3 badge bg-warning text-dark">active</p>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                       ...
                                                       {/* <button onClick={() => handleDeleteCourse(c?.course_id)} className="btn btn-danger btn-sm mt-3 me-1">
                                            ...
                                            {courses?.length < 1 && <p className="p-3">No courses yet</p>}
                                        </tbody>
                                    </table>
                                </div>
                            </div>
