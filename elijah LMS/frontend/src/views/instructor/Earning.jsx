                                ...
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div className="dropdown dropstart">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-end" aria-labelledby="paymentDropdown">
                                            ...
                                            <a className="dropdown-item" href="#">2 Months</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="card-body">
                                    <div className="row">
                                        <div className="col-xl-6 col-lg-6 col-md-12 col-12 mb-3 mb-lg-0">
                                            <div className="border p-3 rounded shadow-sm">
                                                ...
                                                <h3 className="display-4 fw-bold mt-3 mb-0">${stats.total_revenue ? stats.total_revenue.toFixed(2) : 0.00}</h3>
                                        ...
                                        <div className="col-xl-6 col-lg-6 col-md-12 col-12 mb-3 mb-lg-0">
                                            <div className="border p-3 rounded shadow-sm">
                                                <i className="fe fe-shopping-cart icon-shape icon-sm rounded-3 bg-light-success text-dark-success mt-2" />
                                                <h3 className="display-4 fw-bold mt-3 mb-0">${stats.monthly_revenue ? stats.monthly_revenue.toFixed(2) : 0.00}</h3>
