...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'userauths.context_processors.user_type_context',  # Add this line
...
BASE_CURRENCY = "SLE"  # Leone
CURRENCY_SYMBOL = "NLe"  # Symbol to use for display
STRIPE_CURRENCY = "usd"  # Currency for Stripe payments
...
JAZZMIN_SETTINGS = {
    "site_title": "Wi Furniture",
    "site_header": "Wi Furniture",
    "site_brand": "Wi Furniture ",
    # "site_icon": "images/favicon.ico",
    # "site_logo": "images/logos/logo.jpg",
    "welcome_sign": "Welcome To Wi Furniture",
    "copyright": "Desphixs",
