...
urlpatterns = [
    ...
    path('manager/attendance/print/', manager_views.PrintAttendanceView.as_view(), name='print_attendance'),
    ...
    # Forget password
    path('password_reset/', views.PasswordResetView.as_view(template_name='main_app/password_reset_form.html'), name='password_reset'),
    path('password_reset/done/', views.PasswordResetDoneView.as_view(template_name='main_app/password_reset_done.html'), name='password_reset_done'),
    path('reset/<uidb64>/<token>/', views.PasswordResetConfirmView.as_view(template_name='main_app/password_reset_confirm.html'), name='password_reset_confirm'),
    path('reset/done/', views.PasswordResetCompleteView.as_view(template_name='main_app/password_reset_complete.html'), name='password_reset_complete'),
...
#     path("manager/get_employees/", manager_views.get_employees, name='get_employees'),
    ...
    path("get_employees/", manager_views.fetch_employees, name="get_employees"),
...
#     path("manager/attendance/update/", manager_views.update_attendance, name='update_attendance'),
    path("manager/attendance/update/", manager_views.manager_update_attendance, name="update_attendance"),
